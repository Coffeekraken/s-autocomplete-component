...
var _striptags = _interopRequireDefault(require("coffeekraken-sugar/js/utils/strings/striptags"));

var _dispatchEvent = _interopRequireDefault(require("coffeekraken-sugar/js/dom/dispatchEvent"));

var _isHover = _interopRequireDefault(require("coffeekraken-sugar/js/dom/isHover"));

var _isInIframe = _interopRequireDefault(require("coffeekraken-sugar/js/dom/isInIframe"));
...
function (_STemplateComponent) {
  ...
  function SAutocompleteComponent() {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(SAutocompleteComponent).apply(this, arguments));
  }

  _createClass(SAutocompleteComponent, [{
    ...
    value: function componentWillMount() {
      _get(_getPrototypeOf(SAutocompleteComponent.prototype), "componentWillMount", this).call(this); // get the target input


      if (this.props.for instanceof HTMLElement) {
        this._$targetInput = this.props.for;
      } else if (typeof this.props.for === 'string') {
        this._$targetInput = document.querySelector("#".concat(this.props.for, ",[name=\"").concat(this.props.for, "\"]"));
      }

      if (!this._$targetInput) {
        throw new Error("The ".concat(this.componentNameDash, " component need a proper \"for\" target..."));
      } // some variables
    ...
    value: function componentMount() {
      ...
      _get(_getPrototypeOf(SAutocompleteComponent.prototype), "componentMount", this).call(this); // get the template html from component itself
      ...
      var searchDebouncedFn = (0, _debounce.default)(this._search.bind(this), this.props.debounce); // listen for keydown

      this._removeKeydownHandler = (0, _addEventListener.default)(document, 'keydown', function (e) {
      ...
      this._removeScrollHandler = (0, _addEventListener.default)(window, 'scroll', function (e) {
        // set size and position
        _this._setSizeAndPosition();
      }); // lsiten for resize

      this._removeResizeHandler = (0, _addEventListener.default)(window, 'resize', function (e) {
        // set size and position
        _this._setSizeAndPosition(true);
      }); // listen for focus in the target element

      this._removeFocusHandler = (0, _addEventListener.default)(this._$targetInput, 'focus', function (e) {
      ...
      this._removeBlurHandler = (0, _addEventListener.default)(this._$targetInput, 'blur', function (e) {
        var closeTimeout = 0; // check if the mouse if hover the autocomplete

        if ((0, _isHover.default)(_this) || (0, _isInIframe.default)()) {
      ...
      this._removeTargetClickHandler = (0, _addEventListener.default)(this._$targetInput, 'click', function (e) {
        if (_this.props.openOnFocus) {
          // open the autocomplete
          _this._search(_this._$targetInput.value);
      ...
      this._removeInputChangeHandler = (0, _addEventListener.default)(this._$targetInput, 'input', function (e) {
        // if the input is empty, reset the results
        if (e.target.value && e.target.value.length < _this.props.minLengthForSearch) {
          _this.state.results = [];
          return;
        } // make the search
    ...
    value: function componentUnmount() {
      _get(_getPrototypeOf(SAutocompleteComponent.prototype), "componentUnmount", this).call(this);
    ...
    value: function componentWillReceiveProp(name, newVal, oldVal) {
      _get(_getPrototypeOf(SAutocompleteComponent.prototype), "componentWillReceiveProp", this).call(this, name, newVal, oldVal);
    }
    /**
    ...
    value: function render() {
      ...
      if (this.state.isOpened) {
        ...
        var regexp = new RegExp('(' + this._$targetInput.value + ')(?!([^<]+)?>)', 'gi');

        if (this.state.isLoading) {
          _get(_getPrototypeOf(SAutocompleteComponent.prototype), "render", this).call(this, _coffeekrakenSTemplateComponent.default.createElement("div", {
            class: "".concat(this.componentNameDash, "__loading")
          }, _coffeekrakenSTemplateComponent.default.createElement("div", {
            class: "".concat(this.componentNameDash, "__loader")
          })));
        } else {
          _get(_getPrototypeOf(SAutocompleteComponent.prototype), "render", this).call(this, _coffeekrakenSTemplateComponent.default.createElement("ul", {
            class: "".concat(this.componentNameDash, "__results")
            ...
            return _coffeekrakenSTemplateComponent.default.createElement("li", {
              ...
              class: "".concat(_this2.componentNameDash, "__result ").concat(idx === _this2.state.selectedResultIdx ? 'active' : ''),
              dangerouslySetInnerHTML: {
                __html: _mustache.default.render(_this2._htmlTemplate, result).replace(regexp, "<span class=\"".concat(_this2.componentNameDash, "__search-result\">$1</span>"))
              }
            });
          })));
        }
    ...
    value: function _chooseSelectedResult() {
      ...
      var $selectedResult = this.querySelector("[idx=\"".concat(this.state.selectedResultIdx, "\"]")); // try to get the value.
      ...
      var value = null;
      var $sAutocompleteValueElm = $selectedResult.querySelector("[".concat(this.componentNameDash, "-value]"));

      if ($sAutocompleteValueElm) {
        value = $sAutocompleteValueElm.getAttribute("".concat(this.componentNameDash, "-value"));
      ...
      this.props.onChoose && this.props.onChoose(selectedJson); // close the autocomplete
    ...
    value: function _scrollToSelectedResult() {
      // we need a selectedResultIdx to work with
      if (this.state.selectedResultIdx === null || !this.state.results.length) return; // query the result item in the dom

      var $result = this.querySelector("[idx=\"".concat(this.state.selectedResultIdx, "\"]")); // calculate the offset relative to the parent

      var resultOffsetParent = (0, _offsetParent.default)($result); // check if the selected result is above or bellow the fold

      if (resultOffsetParent.top - this.scrollTop + $result.offsetHeight >= this.offsetHeight) {
        this.scrollTop = resultOffsetParent.top - this.offsetHeight + $result.offsetHeight;
    ...
    value: function _setSizeAndPosition() {
      ...
      var targetInputTop = targetInputOffset.top - (0, _scrollTop.default)();
      var targetInputLeft = targetInputOffset.left - (0, _scrollLeft.default)();
      var targetInputHeight = this._$targetInput.offsetHeight;
      var targetInputOffsetBottom = window.innerHeight - (targetInputTop + targetInputHeight);
      var dropup = false;
      ...
      if (dropup) {
        // set the position
        this.style.top = 'auto';
        this.style.bottom = "".concat(window.innerHeight - targetInputTop + this.props.offset, "px");
        this.style.left = "".concat(targetInputLeft, "px");
        this.style.maxHeight = "".concat(targetInputTop - this.props.screenMarginTop - this.props.offset, "px");
      } else {
        // set the position
        this.style.bottom = 'auto';
        this.style.top = "".concat(targetInputTop + targetInputHeight + this.props.offset, "px");
        this.style.left = "".concat(targetInputLeft, "px");
        this.style.maxHeight = "".concat(window.innerHeight - (targetInputTop + targetInputHeight) - this.props.screenMarginBottom - this.props.offset, "px");
      }
    ...
    value: function () {
      ...
      /*#__PURE__*/
      regeneratorRuntime.mark(function _callee(keywords) {
        var response;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 9:
                ...
                this._cache[keywords] = response.data; // save the results in the state
    ...
    value: function defaultCss(componentName, componentNameDash) {
      return "\n      ".concat(componentNameDash, " {\n        display : block;\n        position: fixed;\n        overflow-x: hidden;\n        overflow-y: auto;\n        opacity: 0;\n        pointer-events: none;\n      }\n      ").concat(componentNameDash, ".force-close {\n        display: none;\n        pointer-events: none !important;\n      }\n\n      ").concat(componentNameDash, ".active {\n        opacity: 1;\n        pointer-events: all;\n      }\n      .").concat(componentNameDash, "__result:hover,\n      .").concat(componentNameDash, "__result.active {\n        cursor: pointer;\n      }\n      .").concat(componentNameDash, "__search-result {\n        font-weight: bold;\n      }\n    ");
    }
  }, {
    key: "defaultProps",
